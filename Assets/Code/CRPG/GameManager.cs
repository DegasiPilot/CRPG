...
public class GameManager : MonoBehaviour
{
    ...
    private void ShowAttackInfo(Personage personage)
    {
        ...
        {
			if (distance <= _activePlayer.MaxAttackDistance && !BattleManager.AttackRaycast(_activePlayer.Personage.HitPoint.position, personage.HitPoint.position, _activePlayer.MaxAttackDistance, personage))
			{
            ...
            if(GameMode == GameMode.Battle && distance > _activePlayer.MaxAttackDistance)
            {
